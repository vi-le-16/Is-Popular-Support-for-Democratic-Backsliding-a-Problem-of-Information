...
##### All Respondents, contrasting dosage 1 versus dosage 2 ##### 
...
ggplot(summary_df, aes(x = dosage_group, y = mean_response)) +
  ...
  labs(
    ...
    title = "Effect of Information Dosage on Confidence among All Respondents",
...
ggplot(summary_df, aes(x = dosage_group, y = mean_response)) +
  ...
  labs(
    ...
    title = "Effect of Information Dosage on Degree of Anger among All Respondents",
...
ggplot(summary_df, aes(x = dosage_group, y = mean_response)) +
  ...
  labs(
    ...
    title = "Effect of Information Dosage on Interest in the Opposition among All Respondents",
...
##### All Respondents, contrasting more versus less liberal #####

# Helper to produce the summary table + plot for a single question

plot_by_lean_all_respondents <- function(question_code, y_label, plot_title, plot_subtitle,
...
p_q2 <- plot_by_lean_all_respondents(
  question_code = "Q2",
...
p_q3 <- plot_by_lean_all_respondents(
  question_code = "Q3",
...
p_q6 <- plot_by_lean_all_respondents(
  question_code = "Q6",
...
##### All Respondents, contrasting high/low media embeddedness #####

plot_by_embeddedness_all_respondents <- function(question_code, y_label, plot_title, plot_subtitle,
                                        id_col = "respondent_id") {
...
p_q2_emb <- plot_by_embeddedness_all_respondents(
  question_code = "Q2",
  y_label = "Average confidence in the Fidesz government",
  plot_title = "Effect of Media Embeddedness on Confidence (All Respondents)",
  plot_subtitle = "0 = losing confidence completely; 1 = confidence remains unchanged\n(thick bars = 90% CI, thin bars = 95% CI)"
)
print(p_q2_emb)

# Q3 — anger (embeddedness)
p_q3_emb <- plot_by_embeddedness_all_respondents(
  question_code = "Q3",
  y_label = "Average level of anger",
  plot_title = "Effect of Media Embeddedness on Degree of Anger (All Respondents)",
  plot_subtitle = "0 = completely indifferent; 1 = very angry\n(thick bars = 90% CI, thin bars = 95% CI)"
)
print(p_q3_emb)

# Q6 — interest in the opposition (embeddedness)
p_q6_emb <- plot_by_embeddedness_all_respondents(
  question_code = "Q6",
  y_label = "Average interest in the Opposition",
  plot_title = "Effect of Media Embeddedness on Interest in the Opposition (All Respondents)",
  plot_subtitle = "0 = does not change my interest at all; 1 = increases my interest substantially\n(thick bars = 90% CI, thin bars = 95% CI)"
)
print(p_q6_emb)

# Plot by education (All Respondents only) # 
plot_by_education_all_respondents <- function(question_code, y_label, plot_title, plot_subtitle,
                                     id_col = "respondent_id") {
...
# ---- Education-based plots (All Respondents) ----

p_q2_edu <- plot_by_education_all_respondents(
  question_code = "Q2",
  y_label = "Average confidence in the Fidesz government",
  plot_title = "Effect of Education on Confidence (All Respondents)",
  plot_subtitle = "0 = losing confidence completely; 1 = confidence remains unchanged\n(thick bars = 90% CI, thin bars = 95% CI)"
)
print(p_q2_edu)

p_q3_edu <- plot_by_education_all_respondents(
  question_code = "Q3",
  y_label = "Average level of anger",
  plot_title = "Effect of Education on Degree of Anger (All Respondents)",
  plot_subtitle = "0 = completely indifferent; 1 = very angry\n(thick bars = 90% CI, thin bars = 95% CI)"
)
print(p_q3_edu)

p_q6_edu <- plot_by_education_all_respondents(
  question_code = "Q6",
  y_label = "Average interest in the Opposition",
  plot_title = "Effect of Education on Interest in the Opposition (All Respondents)",
  plot_subtitle = "0 = does not change my interest at all; 1 = increases my interest substantially\n(thick bars = 90% CI, thin bars = 95% CI)"
)
print(p_q6_edu)
...
# Updated helper: plot by media embeddedness (All Respondents only) with dosage grouping
plot_by_dos_embeddedness_all_respondents <- function(question_code,
                                            y_label,
                                            plot_title,
                                            plot_subtitle,
                                            id_col = "respondent_id",
  ...
  # prepare df filtered to question + All Respondents + comp_high 0/1
  df <- data %>%
    filter(
      question == question_code,
...
p_q2_emb <- plot_by_dos_embeddedness_all_respondents(
  question_code = "Q2",
  y_label = "Average confidence in the Fidesz government",
  plot_title = "Effect of Media Embeddedness & Dosage on Confidence (All Respondents)",
  plot_subtitle = "0 = losing confidence completely; 1 = confidence remains unchanged\n(thick bars = 90% CI, thin bars = 95% CI)"
)
print(p_q2_emb)

p_q3_emb <- plot_by_dos_embeddedness_all_respondents(
  question_code = "Q3",
  y_label = "Average level of anger",
  plot_title = "Effect of Media Embeddedness & Dosage on Degree of Anger (All Respondents)",
  plot_subtitle = "0 = completely indifferent; 1 = very angry\n(thick bars = 90% CI, thin bars = 95% CI)"
)
print(p_q3_emb)

p_q6_emb <- plot_by_dos_embeddedness_all_respondents(
  question_code = "Q6",
  y_label = "Average interest in the Opposition",
  plot_title = "Effect of Media Embeddedness & Dosage on Interest in the Opposition (All Respondents)",
  plot_subtitle = "0 = does not change my interest at all; 1 = increases my interest substantially\n(thick bars = 90% CI, thin bars = 95% CI)"
)
print(p_q6_emb)
...
# Updated helper: plot by education (All Respondents only) with dosage grouping
plot_by_education_dos_all_respondents <- function(question_code,
                                         y_label,
                                         plot_title,
                                         plot_subtitle,
                                         id_col = "respondent_id",
  ...
  # prepare df filtered to question + All Respondents + education levels 0/1
  df <- data %>%
    filter(
      question == question_code,
...
p_q2_edu <- plot_by_education_dos_all_respondents(
  question_code = "Q2",
  y_label = "Average confidence in the Fidesz government",
  plot_title = "Effect of Education & Dosage on Confidence (All Respondents)",
  plot_subtitle = "0 = losing confidence completely; 1 = confidence remains unchanged\n(thick bars = 90% CI, thin bars = 95% CI)"
)
print(p_q2_edu)

p_q3_edu <- plot_by_education_dos_all_respondents(
  question_code = "Q3",
  y_label = "Average level of anger",
  plot_title = "Effect of Education & Dosage on Degree of Anger (All Respondents)",
  plot_subtitle = "0 = completely indifferent; 1 = very angry\n(thick bars = 90% CI, thin bars = 95% CI)"
)
print(p_q3_edu)

p_q6_edu <- plot_by_education_dos_all_respondents(
  question_code = "Q6",
  y_label = "Average interest in the Opposition",
  plot_title = "Effect of Education & Dosage on Interest in the Opposition (All Respondents)",
  plot_subtitle = "0 = does not change my interest at all; 1 = increases my interest substantially\n(thick bars = 90% CI, thin bars = 95% CI)"
)
print(p_q6_edu)
...
### All Respondents comparing Dosage 1 versus Dosage 2, RAND1 - RAND7 ### 
...
### All Respondents comparing effect of political leaning [left, centrist, right], RAND1 - RAND7 ###
...
plot_by_lean_rand_combined <- function(data, rand, qcode,
  ...
  # restrict to All Respondents and valid pol_lean values
  df <- data %>%
    filter(as.character(pol_lean) %in% c("0", "1", "2")) %>%
    mutate(
...
### All Respondents comparing high/low media embeddedness for RAND1 - RAND7 ### 
...
plot_by_embeddedness_rand_combined <- function(data, rand, qcode,
  ...
  # restrict to All Respondents and comp_high coded 0/1
  df <- data %>%
    filter(comp_high %in% c(0, 1)) %>%
    mutate(
      response = as.numeric(.data[[varname]]),
      comp_high_f = factor(comp_high, levels = c(0, 1),
                           labels = c("Low embeddedness", "High embeddedness"))
...
### All Respondents comparing high/low education x dosage 1/2, RAND 1 - RAND7 ### 
...
plot_by_dos_embeddedness_rand_combined <- function(data, rand, qcode,
  ...
  # restrict to All Respondents and comp_high coded 0/1
  df <- data %>%
    filter(.data[[embedded_col]] %in% c(0, 1)) %>%
    mutate(
      response = as.numeric(.data[[varname]]),
      embedded_f = factor(.data[[embedded_col]], levels = c(0, 1),
                          labels = c("Low embeddedness", "High embeddedness")),
...
### All Respondents comparing high/low education, RAND1 - RAND7 ### 
...
plot_by_education_rand_combined <- function(data, rand, qcode,
  ...
  # restrict to All Respondents and education_level coded 0/1
  df <- data %>%
    filter(education_level %in% c(0, 1)) %>%
    mutate(
      response = as.numeric(.data[[varname]]),
      education_f = factor(education_level, levels = c(0, 1),
                           labels = c("Low education", "High education"))
...
plot_q2_by_education_rand <- function(rand, data, id_col = "respondent_id") {
  plot_by_education_rand_combined(
    data = data, rand = rand, qcode = 2,
    y_label = "Average confidence in the Fidesz government",
    plot_title = paste0("Effect of Education on Confidence (RAND ", rand, "; All Respondents)"),
    plot_subtitle = "0 = losing confidence completely; 1 = confidence remains unchanged\n(thick bars = 90% CI, thin bars = 95% CI)",
    id_col = id_col
  )
}
...
plot_q3_by_education_rand <- function(rand, data, id_col = "respondent_id") {
  plot_by_education_rand_combined(
    data = data, rand = rand, qcode = 3,
    y_label = "Average level of anger",
    plot_title = paste0("Effect of Education on Degree of Anger (RAND ", rand, "; All Respondents)"),
    plot_subtitle = "0 = completely indifferent; 1 = very angry\n(thick bars = 90% CI, thin bars = 95% CI)",
    id_col = id_col
  )
}
...
plot_q6_by_education_rand <- function(rand, data, id_col = "respondent_id") {
  plot_by_education_rand_combined(
    data = data, rand = rand, qcode = 6,
    y_label = "Average interest in the Opposition",
    plot_title = paste0("Effect of Education on Interest in the Opposition (RAND ", rand, "; All Respondents)"),
    plot_subtitle = "0 = does not change my interest at all; 1 = increases my interest substantially\n(thick bars = 90% CI, thin bars = 95% CI)",
    id_col = id_col
  )
}
...
### All Respondents comparing high/low media embeddedness x dosage 1/2, RAND 1 - RAND7 ### 
...
plot_by_dos_education_rand_combined <- function(data, rand, qcode,
  ...
  # restrict to All Respondents and education_level coded 0/1
  df <- data %>%
    filter(.data[[education_col]] %in% c(0, 1)) %>%
    mutate(
      response = as.numeric(.data[[varname]]),
      education_f = factor(.data[[education_col]], levels = c(0, 1),
                           labels = c("Low education", "High education")),
...
# Plot by illeberalism/democratic leaning (All Respondents only) # 
plot_by_illib_lean_all_respondents <- function(question_code, y_label, plot_title, plot_subtitle,
                                      id_col = "respondent_id") {
...
# ---- Illiberal/Democratic -based plots (All Respondents) ----

p_q2_illib_lean <- plot_by_illib_lean_all_respondents(
  question_code = "Q2",
  y_label = "Average confidence in the Fidesz government",
  plot_title = "Effect of Illiberal/Democratic Leaning on Confidence (All Respondents)",
  plot_subtitle = "0 = losing confidence completely; 1 = confidence remains unchanged\n(thick bars = 90% CI, thin bars = 95% CI)"
)
print(p_q2_illib_lean)

p_q3_illib_lean <- plot_by_illib_lean_all_respondents(
  question_code = "Q3",
  y_label = "Average level of anger",
  plot_title = "Effect of Illiberal/Democratic Leaning on Degree of Anger (All Respondents)",
  plot_subtitle = "0 = completely indifferent; 1 = very angry\n(thick bars = 90% CI, thin bars = 95% CI)"
)
print(p_q3_illib_lean)

p_q6_illib_lean <- plot_by_illib_lean_all_respondents(
  question_code = "Q6",
  y_label = "Average interest in the Opposition",
  plot_title = "Effect of Illiberal/Democratic Leaning on Interest in the Opposition (All Respondents)",
  plot_subtitle = "0 = does not change my interest at all; 1 = increases my interest substantially\n(thick bars = 90% CI, thin bars = 95% CI)"
)
print(p_q6_illib_lean)

### All Respondents comparing Illiberalism/Democratic Leaning, RAND1 - RAND7 ### 
...
plot_by_illib_lean_rand_combined <- function(data, rand, qcode,
  ...
  # restrict to All Respondents and new_illib_binary coded 0/1
  df <- data %>%
    filter(new_illib_binary %in% c(0, 1)) %>%
    mutate(
      response = as.numeric(.data[[varname]]),
      illib_lean_f = factor(new_illib_binary, levels = c(0, 1),
                            labels = c("Illiberal Leaning", "Democratic Leaning"))
...
plot_q2_by_illib_lean_rand <- function(rand, data, id_col = "respondent_id") {
  plot_by_illib_lean_rand_combined(
    data = data, rand = rand, qcode = 2,
    y_label = "Average confidence in the Fidesz government",
    plot_title = paste0("Effect of Illiberalism/Democratic Leaning on Confidence (RAND ", rand, "; All Respondents)"),
    plot_subtitle = "0 = losing confidence completely; 1 = confidence remains unchanged\n(thick bars = 90% CI, thin bars = 95% CI)",
    id_col = id_col
  )
}
...
plot_q3_by_illib_lean_rand <- function(rand, data, id_col = "respondent_id") {
  plot_by_illib_lean_rand_combined(
    data = data, rand = rand, qcode = 3,
    y_label = "Average level of anger",
    plot_title = paste0("Effect of Illiberalism/Democratic Leaning on Degree of Anger (RAND ", rand, "; All Respondents)"),
    plot_subtitle = "0 = completely indifferent; 1 = very angry\n(thick bars = 90% CI, thin bars = 95% CI)",
    id_col = id_col
  )
}
...
plot_q6_by_illib_lean_rand <- function(rand, data, id_col = "respondent_id") {
  plot_by_illib_lean_rand_combined(
    data = data, rand = rand, qcode = 6,
    y_label = "Average interest in the Opposition",
    plot_title = paste0("Effect of Illiberalism/Democratic Leaning on Interest in the Opposition (RAND ", rand, "; All Respondents)"),
    plot_subtitle = "0 = does not change my interest at all; 1 = increases my interest substantially\n(thick bars = 90% CI, thin bars = 95% CI)",
    id_col = id_col
  )
}
...
# Plot by illeberalism/democratic leaning (All Respondents only) # 
plot_by_old_aut_all_respondents <- function(question_code, y_label, plot_title, plot_subtitle,
                                   id_col = "respondent_id") {
...
# ---- Authoritarian/Democratic -based plots (All Respondents) ----

p_q2_old_aut <- plot_by_old_aut_all_respondents(
  question_code = "Q2",
  y_label = "Average confidence in the Fidesz government",
  plot_title = "Effect of Authoritarian/Democratic Leaning on Confidence (All Respondents)",
  plot_subtitle = "0 = losing confidence completely; 1 = confidence remains unchanged\n(thick bars = 90% CI, thin bars = 95% CI)"
)
print(p_q2_old_aut)

p_q3_old_aut <- plot_by_old_aut_all_respondents(
  question_code = "Q3",
  y_label = "Average level of anger",
  plot_title = "Effect of Authoritarian/Democratic Leaning on Degree of Anger (All Respondents)",
  plot_subtitle = "0 = completely indifferent; 1 = very angry\n(thick bars = 90% CI, thin bars = 95% CI)"
)
print(p_q3_old_aut)

p_q6_old_aut <- plot_by_old_aut_all_respondents(
  question_code = "Q6",
  y_label = "Average interest in the Opposition",
  plot_title = "Effect of Authoritarian/Democratic Leaning on Interest in the Opposition (All Respondents)",
  plot_subtitle = "0 = does not change my interest at all; 1 = increases my interest substantially\n(thick bars = 90% CI, thin bars = 95% CI)"
)
print(p_q6_old_aut)

### All Respondents comparing Authoritarian/Democratic Leaning, RAND1 - RAND7 ### 
...
plot_by_old_aut_rand_combined <- function(data, rand, qcode,
  ...
  # restrict to All Respondents and new_aut_binary coded 0/1
  df <- data %>%
    filter(new_aut_binary %in% c(0, 1)) %>%
    mutate(
      response = as.numeric(.data[[varname]]),
      old_aut_f = factor(new_aut_binary, levels = c(0, 1),
                         labels = c("Authoritarian Leaning", "Democratic Leaning"))
...
plot_q2_by_old_aut_rand <- function(rand, data, id_col = "respondent_id") {
  plot_by_old_aut_rand_combined(
    data = data, rand = rand, qcode = 2,
    y_label = "Average confidence in the Fidesz government",
    plot_title = paste0("Effect of Authoritarian/Democratic Leaning on Confidence (RAND ", rand, "; All Respondents)"),
    plot_subtitle = "0 = losing confidence completely; 1 = confidence remains unchanged\n(thick bars = 90% CI, thin bars = 95% CI)",
    id_col = id_col
  )
}
...
plot_q3_by_old_aut_rand <- function(rand, data, id_col = "respondent_id") {
  plot_by_old_aut_rand_combined(
    data = data, rand = rand, qcode = 3,
    y_label = "Average level of anger",
    plot_title = paste0("Effect of Authoritarian/Democratic Leaning on Degree of Anger (RAND ", rand, "; All Respondents)"),
    plot_subtitle = "0 = completely indifferent; 1 = very angry\n(thick bars = 90% CI, thin bars = 95% CI)",
    id_col = id_col
  )
}
...
plot_q6_by_old_aut_rand <- function(rand, data, id_col = "respondent_id") {
  plot_by_old_aut_rand_combined(
    data = data, rand = rand, qcode = 6,
    y_label = "Average interest in the Opposition",
    plot_title = paste0("Effect of Authoritarian/Democratic Leaning on Interest in the Opposition (RAND ", rand, "; All Respondents)"),
    plot_subtitle = "0 = does not change my interest at all; 1 = increases my interest substantially\n(thick bars = 90% CI, thin bars = 95% CI)",
    id_col = id_col
  )
}
